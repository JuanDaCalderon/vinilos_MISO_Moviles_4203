...
class FlujoCompletoSprint2Test {
    ...
    fun flujoCompletoSprint2Test() {
        ...
        textView5.check(matches(withText("Detalle Album")))
        ...
        textView7.check(matches(withText("Crear album")))
        ...
        appCompatEditText.perform(replaceText("Album prueba 1"), closeSoftKeyboard())
        Thread.sleep(1000)
        ...
        appCompatEditText4.perform(replaceText("Creacion album prueba 1"), closeSoftKeyboard())
        Thread.sleep(1000)
        ...
        textView13.check(matches(withText("Coleccionistas")))
